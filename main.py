...
class Detect(Resource):
    ...
    def post(self):
        ...
        if video and allowed_file(video.filename):
            ...
            return send_file(os.path.join('./runs/detect', filename), mimetype='video/mp4', as_attachment=True, download_name=filename)

            #eturn send_file(os.path.join(f"./runs/detect/{filename}", filename), mimetype='video/mp4', as_attachment=True, download_name=filename)
        else:
